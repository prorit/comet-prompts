...
3. **Get Started**  
   ...
   - Choose to **import your Chrome, Edge, or Firefox profile** — or skip by selecting **Do This Later**.  
...
6. **First Use**  
   - Try your first query — for example:  
     > *“Tell me about Comet.”*  
...
| 8 | **SEO keyword analysis** | Analyze a competitor’s blog post to extract their SEO strategy. | ```Analyze this competitor’s article on "AI in Marketing". Identify primary and secondary keywords, compute keyword density for "AI marketing automation", and suggest three long-tail keywords they appear to target implicitly.``` |
...
| 10 | **Tone & style adaptation** | Rewrite a paragraph from a technical document to match your company’s blog voice. | ```Rewrite the second paragraph of this technical document to match an "Expert but Approachable" blog tone (concise, friendly, and accurate). Preserve technical details; reduce jargon where possible.``` |
...
| 13 | **Competitor ad copy analysis** | Deconstruct the psychology in a competitor’s Facebook ad. | ```Analyze this Facebook Ad Library entry. Identify use of scarcity, social proof, and urgency. Propose an alternative angle and 2 headline variations that ethically outperform their positioning.``` |
